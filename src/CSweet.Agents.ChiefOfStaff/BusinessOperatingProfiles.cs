...
internal static class BusinessOperatingProfiles
{
    ...
    private static readonly IReadOnlyDictionary<string, BusinessOperatingProfile> Profiles =
        new[]
        {
            ...
            Profile("game-studio", "Game Studio", "Treat creative direction and product management as distinct ownership. The CEO may also occupy Creative Director; confirm occupancy before recommending that role.",
